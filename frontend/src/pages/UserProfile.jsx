  ...
  return (
    <MobileShell>
      ...
      <div className="px-5 pt-6 pb-32 space-y-5">
        <div className="flex items-center gap-4 p-5 bg-[#151923] border border-white/5 rounded-2xl fade-up">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#9333EA] to-[#7C3AED] flex items-center justify-center font-heading font-bold text-2xl text-black">
            {user.name[0]}
          </div>
          <div>
            <p className="font-heading text-xl font-semibold">{user.name}</p>
            <p className="text-sm text-[#94A3B8] flex items-center gap-1.5"><Phone className="w-3 h-3" /> +91 {user.mobile}</p>
          </div>
        </div>
